export const article = {
  ...
  relatedGuides: [
    ...
    { type: 'insurance' as const, slug: 'furnace', name: 'Does Insurance Cover Furnace Replacement?' },
    { type: 'insurance' as const, slug: 'home-warranty-vs-insurance', name: 'Home Warranty vs Insurance' },
  ],
}
