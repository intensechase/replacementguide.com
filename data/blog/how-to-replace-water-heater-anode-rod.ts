export const article = {
  slug: 'how-to-replace-water-heater-anode-rod',
  ...
  relatedGuides: [
    ...
    { type: 'maintenance' as const, slug: 'water-heater-flush', name: 'How to Flush a Water Heater' },
  ],
}
