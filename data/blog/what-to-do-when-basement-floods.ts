export const article = {
  slug: 'what-to-do-when-basement-floods',
  ...
  relatedGuides: [
    { type: 'troubleshoot' as const, slug: 'sump-pump-not-working', name: 'Sump Pump Not Working' },
    { type: 'insurance' as const, slug: 'water-damage', name: 'Does Insurance Cover Water Damage?' },
    { type: 'insurance' as const, slug: 'pipe-burst', name: 'Does Insurance Cover a Burst Pipe?' },
  ],
}
