export const content = {
  ...
  warningSigns: [
    { sign: 'Condensation between panes', detail: 'Fog or moisture trapped between the two layers of glass means the seal has failed and the insulating gas has escaped... the window is now just two pieces of glass.' },
    { sign: 'Drafts near closed windows', detail: 'Hold a candle or incense stick near the window frame on a windy day... if the flame flickers or smoke moves, air is getting through.' },
    { sign: 'Difficulty opening or closing', detail: 'Windows that stick, jam, or won\'t stay open indicate frame warping from moisture damage or foundation settling... either way, the seal is likely compromised.' },
    { sign: 'Visible frame rot or decay', detail: 'Soft spots, peeling paint, or crumbling material on wood frames means moisture has been working its way in for a while.' },
    { sign: 'Higher energy bills', detail: 'If your heating or cooling costs have crept up without explanation, failed window seals are a common culprit... old single-pane or failed double-pane windows can account for 25 to 30% of heating and cooling loss.' },
    { sign: 'Outside noise is louder than it used to be', detail: 'Double-pane windows dampen sound significantly... if street noise seems louder, the gas layer between panes has likely leaked out.' },
    { sign: 'Cold glass in winter', detail: 'Touch the interior glass surface on a cold day... if it feels nearly as cold as outside air, the window has lost its insulating value.' },
  ],
  repairOrReplace: `Window repairs are limited compared to other home systems. If just the glass seal failed but the frame is solid, some companies offer "foggy window repair" where they drill a small hole, clean the inside, and reseal... it costs $75 to $150 per window. But honestly, the results are mixed and the fix doesn't restore the insulating gas layer, so you lose some energy efficiency. Hardware issues like broken locks, balancers (the mechanism that holds the window open), or cranks can be replaced for $20 to $100 per window and are worth doing if the window is otherwise in good shape. The replace decision usually comes down to two things: frame condition and energy costs. If the frames are rotting, warping, or you're dealing with single-pane windows... replace. Modern low-E, double-pane windows cost $300 to $1,000 per window installed, depending on size and frame material. A full house with 15 to 20 windows runs $6,000 to $15,000. That's real money, but Energy Star estimates you'll save $125 to $465 per year on energy bills by upgrading from single-pane to double-pane. If you're replacing, don't go one at a time unless budget forces it. Most window companies offer better pricing for whole-house jobs, and you avoid the awkward period of having mismatched windows. Vinyl double-pane with low-E coating gives you the best value for most climates.`,
  maintenanceTips: [
  ...
  recommendedProducts: [
    { name: '3M Indoor Window Insulation Kit (5-Window)', description: 'Adds a dead-air layer over failed seals that cuts heat loss by up to 70% per window, buying time until replacement.', priceRange: '$15-$22', amazonUrl: 'https://www.amazon.com/s?k=3M+indoor+window+insulation+kit&tag=replacementgu-20' },
    { name: 'Frost King V25 Weatherstrip Tape (17ft)', description: 'Seals drafty window frames in minutes and can reduce heating costs by 10-15% per window for under a dollar per foot.', priceRange: '$5-$10', amazonUrl: 'https://www.amazon.com/s?k=Frost+King+V25+weatherstrip+tape&tag=replacementgu-20' },
    { name: 'Duck Brand Window Seal Rubber Weatherstrip Kit', description: 'Replaces worn-out compression seals around window sashes to restore the airtight fit the window had when it was new.', priceRange: '$8-$15', amazonUrl: 'https://www.amazon.com/s?k=Duck+Brand+window+seal+weatherstrip+kit&tag=replacementgu-20' },
  ],
}
